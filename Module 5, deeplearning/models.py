...
#training:
    def __init__(self, units, hidden_layers, learning_rate):
        ...
        self.testing_cases = mb.load_mnist(dataset='testing')
...
test()
    ...
    #   hidden = T.tanh( T.dot(input_matrix, weight_input) + biases_hidden)
    ...
    #     x1 = Tann.sigmoid(T.dot(input_matrix, w1) + b1)
